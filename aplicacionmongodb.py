...
def eliminar_estudiante():
    ...
    obj_PyMongo.eliminar('usuarios', json_estudiante)
    obj_PyMongo.eliminar('estudiantes', json_usuario)
    obj_PyMongo.desconectar_mongodb()
...
def consulta_general():
    ...
    atributos_estudiante = {"_id": 0, "nombre": 1, "control": 1}
    atributos_kardex = {"_id": 0, "materia": 1, "calificacion": 1, "control": 1}
